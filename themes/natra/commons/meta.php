...
<link rel="stylesheet" href="<?= base_url(IRVAN . "$this->theme_folder/$this->theme/assets/css/slick.css"); ?>">
<link rel="stylesheet" href="<?= base_url(IRVAN . "$this->theme_folder/$this->theme/assets/css/theme.css"); ?>">
<link rel="stylesheet" href="<?= base_url(IRVAN . "$this->theme_folder/$this->theme/assets/css/style.css"); ?>">
...
<script language='javascript' src="<?= base_url(IRVAN . 'assets/front/js/jquery.min.js'); ?>"></script>
<script language='javascript' src="<?= base_url(IRVAN . 'assets/front/js/jquery.cycle2.min.js'); ?>"></script>
<script language='javascript' src="<?= base_url(IRVAN . 'assets/front/js/jquery.cycle2.carousel.js'); ?>"></script>
<script src="<?= base_url(IRVAN . "$this->theme_folder/$this->theme/assets/js/bootstrap.min.js"); ?>"></script>
<script src="<?= base_url(IRVAN . 'assets/js/leaflet.js'); ?>"></script>
<script src="<?= base_url(IRVAN . 'assets/front/js/layout.js'); ?>"></script>
...
<script src="<?= base_url(IRVAN . 'assets/js/highcharts/highcharts-3d.js'); ?>"></script>
...
<script src="<?= base_url(IRVAN . 'assets/js/highcharts/sankey.js'); ?>"></script>
<script src="<?= base_url(IRVAN . 'assets/js/highcharts/organization.js'); ?>"></script>
<script src="<?= base_url(IRVAN . 'assets/js/highcharts/accessibility.js'); ?>"></script>
<script src="<?= base_url(IRVAN . 'assets/js/mapbox-gl.js'); ?>"></script>
<script src="<?= base_url(IRVAN . 'assets/js/leaflet-mapbox-gl.js'); ?>"></script>
<script src="<?= base_url(IRVAN . 'assets/js/peta.js'); ?>"></script>
...
<!--[if lt IE 9]>
<script src="<?= base_url(IRVAN . "$this->theme_folder/$this->theme/assets/js/html5shiv.min.js"); ?>"></script>
<script src="<?= base_url(IRVAN . "$this->theme_folder/$this->theme/assets/js/respond.min.js"); ?>"></script>
<![endif]-->
