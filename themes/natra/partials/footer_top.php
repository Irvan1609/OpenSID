...
<?php if (!is_null($transparansi)) {
    $this->load->view($folder_themes. '/partials/apbdesa-tema.php', $transparansi);
}?>
...
>>>>>>> ec32238eb3e141c01ed908fd0401488c17ee0629
        ...
        <div class="col-md-6">
        	...
        	<a href="<?= site_url(); ?>first/statistik/4"><img alt="Statistik Jenis Kelamin" width="30%" src="<?= base_url(IRVAN . "$this->theme_folder/$this->theme/images/statistik_kelamin.png") ?>" /></a>
        	<a href="<?= site_url(); ?>first/statistik/13"><img alt="Statistik Umur" width="30%" src="<?= base_url(IRVAN . "$this->theme_folder/$this->theme/images/statistik_umur.png") ?>" /></a>
        <hr></div>
    </div>
