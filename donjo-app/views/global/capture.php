<link rel="stylesheet" href="<?= base_url(IRVAN . 'assets/css/camera.css'); ?>">
<link rel="stylesheet" href="<?= base_url(IRVAN . 'assets/css/cropper.min.css'); ?>">
...
<script src="<?= base_url(IRVAN . 'assets/js/webcam.min.js'); ?>"></script>
<script src="<?= base_url(IRVAN . 'assets/js/cropper.min.js'); ?>"></script>
<script src="<?= base_url(IRVAN . 'assets/js/main-camera.js'); ?>"></script>
