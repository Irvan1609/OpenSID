	...
	<div class="box box-info box-solid">
			<div class="box-body">
				...
				<?php if ($this->web_widget_model->get_setting('aparatur_desa', 'overlay') == true): ?>
					<span class="cycle-prev"><img src="<?= base_url(IRVAN)?>assets/images/back_button.png" alt="Back"></span>
			    <span class="cycle-next"><img src="<?= base_url(IRVAN)?>assets/images/next_button.png" alt="Next"></span>
