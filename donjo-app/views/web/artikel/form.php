<script type="text/javascript" src="<?= base_url(IRVAN)?>assets/js/tinymce/tinymce.min.js"></script>
<script type="text/javascript">
	tinymce.init(
	{
		...
		image_advtab: true ,
		external_filemanager_path:"<?= base_url(IRVAN)?>assets/filemanager/",
		filemanager_title:"Responsive Filemanager" ,
		filemanager_access_key:"<?= $this->session->fm_key; ?>",
		external_plugins:
		{
			"filemanager" : "<?= base_url(IRVAN)?>assets/filemanager/plugin.min.js"
		},
		templates: [
		{
						...
						<div class="box-body no-padding">
							<div class="col-sm-12">
								<div class="form-group">
									...
									<?php else: ?>
										<img class="profile-user-img img-responsive img-circle" src="<?= base_url(IRVAN)?>assets/files/logo/home.png" alt="Tidak Ada Gambar">
									<?php endif; ?>
